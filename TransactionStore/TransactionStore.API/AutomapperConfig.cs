...
namespace TransactionStore.API
{
    public class AutomapperConfig : Profile
    {
        public AutomapperConfig()
        {
            ...
            .ForMember(dest => dest.Currency, opts => opts.MapFrom(src => Converters.ConvertRecipientCurrencyPairToCurrency(src.CurrencyPair)))
            ...
            CreateMap<TransferInputModel, TransferDto>()
                ...
                .ForMember(dest => dest.SenderCurrency, opts => opts.MapFrom(src => Converters.ConvertSenderCurrencyPairToCurrency(src.CurrencyPair)))
                .ForMember(dest => dest.RecipientCurrency, opts => opts.MapFrom(src => Converters.ConvertRecipientCurrencyPairToCurrency(src.CurrencyPair)))
