...
namespace TransactionStore.API
{
    public class AutomapperConfig : Profile
    {
        public AutomapperConfig()
        {
            ...
            .ForMember(dest => dest.Currency, opts => opts.MapFrom(src => (Currency)Converters.RecipientCurrencyPairToCurrency(src.CurrencyPair)))
            ...
            CreateMap<TransferInputModel, TransferDto>()
                ...
                .ForMember(dest => dest.SenderCurrency, opts => opts.MapFrom(src => (Currency)Converters.SenderCurrencyPairToCurrency(src.CurrencyPair)))
                .ForMember(dest => dest.RecipientCurrency, opts => opts.MapFrom(src => (Currency)Converters.RecipientCurrencyPairToCurrency(src.CurrencyPair)))
